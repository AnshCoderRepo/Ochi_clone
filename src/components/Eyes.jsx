...
const Eyes = () => {
    ...
    useEffect(() => {
        window.addEventListener("mousemove", (e) => {
            ...
            var angle = Math.atan2(deltaY, deltaX) * (180 / Math.PI); // convert radain to degreee
            setrotate(angle-180);
        })
    })
  return (
      <div  className='eyes w-full h-screen overflow-hidden'>
          <div data-scroll data-scroll-speed="-.7" className=' relative w-full h-full bg-cover bg-center bg-red-700 bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
