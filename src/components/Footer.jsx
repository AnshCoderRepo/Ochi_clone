...
const Footer = () => {
  return (
      <div className=' flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk"]'>
          <div className='w-1/2 h-full flex-col flex justify-between  '>
              <div className='headinng'>
                <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-10 '>Eye -</h1>
                <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-10 '>Opeaing</h1>
              </div>
          ...
          <div className='w-1/2 flex flex-col items-left font-["Founders_Grotesk"]'>
              <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-10 '>Presenation</h1>
              <div className='dets mt-10 font-serif'>
                  <a className ="text-xl font-light" href="#">Facebook</a><br />
                  <a className ="text-xl font-light" href="#">Whatsapp</a><br />
                  <a className ="text-xl font-light" href="#"> Telegram</a>
              </div>
